...
public class PhotonRunnable implements Runnable {
    ...
    public PhotonRunnable() {
        ...
        if (photonCamera != null) {
            photonPoseEstimator = new PhotonPoseEstimator(layout, POSE_STRATEGY, CAMERA_TO_ROBOT.inverse());
            // Replaced above but not sure if correct MR COYNE photonPoseEstimator = new PhotonPoseEstimator(
